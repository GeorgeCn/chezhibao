...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchForm = _react2.default.createClass({
		...
		searchAction: function searchAction(event) {
			var input = event.target.value;
			var timer = null;
			var results = [];
			for (var i = 0, length = this.props.value.length; i < length; i++) {
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Search...', onKeyUp: this.searchAction }),
				_react2.default.createElement(
					'ul',
					{ className: 'search-results', style: { display: this.state.show ? 'block' : 'none' } },
	...
	var NavSide = _react2.default.createClass({
		displayName: 'NavSide',
		...
		render: function render() {
			...
			var items = data.database.map(function (item, index) {
				return _react2.default.createElement(
					'li',
					{ key: index, className: _this.showActive(index), onClick: function onClick() {
					...
					_react2.default.createElement(
						...
						item.content.map(function (subitem, index) {
							return _react2.default.createElement(
								'li',
								{ key: index },
								_react2.default.createElement(
									_reactRouter.Link,
									{ to: '/table/' + (item.name + "_" + subitem.name) },
									_react2.default.createElement('i', { className: 'fa fa-table' }),
									subitem.name
								)
							);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(SearchForm, { value: this.state.tableArray }),
					_react2.default.createElement(
						'nav',
						{ className: 'sidebar' },
						_react2.default.createElement(
	...
	var ContentWrapper = _react2.default.createClass({
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							this.state.title,
							' / ',
							this.state.datatable.name
						),
						_react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: this.state.datatable.table.comment } }),
						_react2.default.createElement(
							'p',
							null,
							'索引',
							this.state.datatable.table.indexes.map(function (item, index) {
								return _react2.default.createElement(
									'li',
									{ key: index },
									item.name,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'tr',
									{ className: 'info' },
									this.state.datatable.table.thead.map(function (item, index) {
										return _react2.default.createElement(
											'td',
											{ key: index },
											item
							...
							_react2.default.createElement(
								'tbody',
								null,
								this.state.datatable.table.tbody.map(function (item, index) {
									return _react2.default.createElement(
										'tr',
										{ key: index },
										item.map(function (item, index) {
											if (item.indexOf('#') == -1) {
												...
												return _react2.default.createElement(
													...
													_react2.default.createElement(
														_reactRouter.Link,
														{ to: '/table/' + item.split('#')[1].replace('.', '_') },
														item.split('#')[0]
													)
												);
											}
	...
	var routes = _react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: '/', component: NavSide },
			_react2.default.createElement(_reactRouter.Route, { path: 'table/:id', component: ContentWrapper })
		)
	);
	_reactDom2.default.render(routes, document.getElementById('wrapper'));
